...
simout = sim('DOF7_model.slx',simulation_time);
...
axes(tab1)
subplot(3,2,1)
plot(simout.zCar,'r','LineWidth',1.5,'DisplayName','Sprung Mass')
hold on
plot(simout.zHubFL,'b','LineWidth',1.5,'DisplayName','Front Unsprung Mass')
hold on
plot(simout.zHubRL,'g','LineWidth',1.5,'DisplayName','Rear Unsprung Mass')
hold on
plot(simout.zTrackFL,'b--','LineWidth',1.5,'DisplayName','Front Surface')
hold on
plot(simout.zTrackRL,'g--','LineWidth',1.5,'DisplayName','Rear Surface')
...
grid on
subplot(3,2,2)
plot(simout.FTyreFL,'b','LineWidth',1.5,'DisplayName','Front Tyre')
hold on
plot(simout.FTyreRL,'g','LineWidth',1.5,'DisplayName','Rear Tyre')
title('Tyre Forces')
xlabel('Time [s]')
ylabel('Tyre Force [N]')
lgd = legend;
...
ylim([-10 10])
subplot(3,2,4)
plot(simout.FSpringFL,'b','LineWidth',1.5,'DisplayName','Front Spring')
hold on
plot(simout.FSpringRL,'g','LineWidth',1.5,'DisplayName','Rear Spring')
title('Spring Forces')
xlabel('Time [s]')
...
hold on
plot(simout.gVertHubFL,'b','LineWidth',1.5,'DisplayName','Front Unsprung Mass')
hold on
plot(simout.gVertHubRL,'g','LineWidth',1.5,'DisplayName','Rear Unsprung Mass')
...
ylim([-1.5e3 1.5e3])
subplot(3,2,6)
plot(simout.FDamperFL,'b','LineWidth',1.5,'DisplayName','Front Damper')
hold on
plot(simout.FDamperRL,'g','LineWidth',1.5,'DisplayName','Rear Damper')
title('Damper Forces')
xlabel('Time [s]')
